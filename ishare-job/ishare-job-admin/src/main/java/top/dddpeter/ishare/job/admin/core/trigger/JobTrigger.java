package top.dddpeter.ishare.job.admin.core.trigger;
...
public class JobTrigger {
    ...
    private static void processTrigger(JobGroup group, JobInfo jobInfo, int finalFailRetryCount, TriggerTypeEnum triggerType, int index, int total){
        ...
        logger.debug(">>>>>>>>>>>ishare-job trigger start, jobId:{}", jobLog.getId());
        ...
        logger.debug(">>>>>>>>>>>ishare-job trigger end, jobId:{}", jobLog.getId());
    }
    ...
    public static ReturnT<String> runExecutor(TriggerParam triggerParam, String address){
        ...
        try {
            ...
            logger.error(">>>>>>>>>>>ishare-job trigger error, please check if the executor[{}] is running.", address, e);
