...
public class JobLogController {
	...
	public String indexBoard(HttpServletRequest request, Model model, @RequestParam(required = false, defaultValue = "0") Integer jobId) {
		...
		return "joblog/board.joblog.index";
	}
