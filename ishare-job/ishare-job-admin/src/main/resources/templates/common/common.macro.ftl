...
<#macro commonHeader>
	<header class="main-header can-hidden">
				...
				<ul class="nav navbar-nav">
                    ...
                    <li class="dropdown">
                        <a href="javascript:" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                            ${I18n.system_welcome} ${Request["JOB_LOGIN_IDENTITY"].username}
...
<#macro commonLeft pageName >
	...
	<aside class="main-sidebar can-hidden">
		...
		<section class="sidebar">
			...
			<ul class="sidebar-menu">
				...
				<#if Request["JOB_LOGIN_IDENTITY"].role == 1>
...
<#macro commonFooter >
	<footer class="main-footer can-hidden">
        Powered by <b>JOB</b>
