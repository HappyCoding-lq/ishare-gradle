package top.dddpeter.ishare.job.rpc.remoting.invoker.impl;
...
import top.dddpeter.ishare.job.rpc.remoting.invoker.annotation.RpcReference;
...
/**
 * ishare-rpc invoker factory, init service-registry and spring-bean by annotation (for spring)
 *
            ...
            public void doWith(Field field) throws IllegalArgumentException, IllegalAccessException {
                if (field.isAnnotationPresent(RpcReference.class)) {
                    ...
                    if (!iface.isInterface()) {
                        throw new RpcException("ishare-rpc, reference(XxlRpcReference) must be interface.");
                    }
                    ...
                    logger.info(">>>>>>>>>>> ishare-rpc, invoker factory init reference bean success. serviceKey = {}, bean.field = {}.{}",
