...
public class JobThread extends Thread{
	...
	public void run() {
		...
		while(!toStop){
            ...
            try {
				...
				if (triggerParam!=null) {
					...
					// execute
					JobLogger.log("<br>-----------ishare-job job execute start -----------<br>----------- Param:" + triggerParam.getExecutorParams());
					...
					if (triggerParam.getExecutorTimeout() > 0) {
						...
						try {
							...
							JobLogger.log("<br>-----------ishare-job job execute timeout");
							JobLogger.log(e);
					...
					JobLogger.log("<br>-----------ishare-job job execute end(finish) -----------<br>----------- ReturnT:" + executeResult);
				...
				JobLogger.log("<br>----------- JobThread Exception:" + errorMsg + "<br>-----------ishare-job job execute end(error) -----------");
			} finally {
                if(triggerParam != null) {
		...
		logger.info(">>>>>>>>>>>ishare-job JobThread stoped, hashCode:{}", Thread.currentThread());
	}
}
