package top.dddpeter.ishare.job.util;
...
public class JobRemotingUtil {
    ...
    public static ReturnT<String> postBody(String url, String accessToken, Object requestObj, int timeout) {
        ...
        try {
            ...
            if (statusCode != 200) {
                return new ReturnT<String>(ReturnT.FAIL_CODE, "ishare-rpc remoting fail, StatusCode("+ statusCode +") invalid. for url : " + url);
            }
            ...
            try {
                ...
                logger.error("ishare-rpc remoting (url="+url+") response content invalid("+ resultJson +").", e);
                return new ReturnT<String>(ReturnT.FAIL_CODE, "ishare-rpc remoting (url="+url+") response content invalid("+ resultJson +").");
            }

        } catch (Exception e) {
            logger.error(e.getMessage(), e);
            return new ReturnT<String>(ReturnT.FAIL_CODE, "ishare-rpc remoting error("+ e.getMessage() +"), for url : " + url);
        } finally {
            try {
