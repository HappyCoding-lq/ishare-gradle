package top.dddpeter.ishare.tool.utils;
...
public class ShortId {
	...
	private static final Long REDUCE_TIME = 252432000000L;
	 ...
	 * @param seedValue Integer value to seed the random alphabet.  ALWAYS USE THE SAME SEED or you might get overlaps.
	 */
	...
	public static String generate() {
		...
		int seconds = (int) Math.floor((System.currentTimeMillis() - REDUCE_TIME + radom) * 0.001);
