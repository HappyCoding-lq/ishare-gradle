package top.dddpeter.ishare.common.auth.aspect;
...
import top.dddpeter.ishare.common.exception.ForbiddenException;
...
public class PreAuthorizeAspect
{
    ...
    @Around("@annotation(top.dddpeter.ishare.common.auth.annotation.HasPermissions)")
