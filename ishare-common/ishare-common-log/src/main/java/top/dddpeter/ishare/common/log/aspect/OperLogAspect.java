package top.dddpeter.ishare.common.log.aspect;
...
import top.dddpeter.ishare.common.log.enums.BusinessStatus;
...
{
    // 配置织入点
    @Pointcut("@annotation(top.dddpeter.ishare.common.log.annotation.OperLog)")
