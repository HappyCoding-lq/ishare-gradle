package top.dddpeter.ishare.common.utils.poi;
...
import top.dddpeter.ishare.common.annotation.Excel.Type;
...
import top.dddpeter.ishare.common.utils.reflect.ReflectUtils;
...
public class ExcelUtil<T>
{
     ...
     * @return 结果
     */
    public ResultDTO exportExcel(List<T> list, String sheetName)
    {
     ...
     * @return 结果
     */
    public ResultDTO importTemplateExcel(String sheetName)
    {
     ...
     * @param index 序号
     * @param rowParam 单元格行
     * @param cellParam 类型单元格
     */
    public void fillExcelData(int index, Row rowParam, Cell cellParam)
    {
        Row row;
        Cell cell;
